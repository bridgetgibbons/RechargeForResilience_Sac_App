...
project <- HTML('<div style="height: 90vh; overflow: auto" class="jumbotron">
  ...
  <p class="lead">This app provides a qualitative view of some of the decision support tool results and considerations. The full decision support tool is free and publically available. To download a copy of the tool, or for more information on the project, please visit our website.</p>
